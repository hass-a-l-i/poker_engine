...
class Table:
    ...
    def begin_round(self, round_name:str, no_cards:int=None):
        print("-----------------------------------")
        print(round_name)
    ...
    def run(self):
        self.deck.shuffle()
        self._deal()
        self.begin_round(round_name="Pre-Flop")
        self.begin_round(round_name="Flop", no_cards=3)
        self.begin_round(round_name="River", no_cards=1)
        self.begin_round(round_name="Turn", no_cards=1)
